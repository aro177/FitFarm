...
const _seedIndigo500 = Color(0xFF6366F1);
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        useMaterial3: true,
        colorScheme: ColorScheme.fromSeed(seedColor: _seedIndigo500, brightness: Brightness.light),
        textTheme: baseText,
      ),
      darkTheme: ThemeData(
        useMaterial3: true,
        colorScheme: ColorScheme.fromSeed(seedColor: _seedIndigo500, brightness: Brightness.dark),
